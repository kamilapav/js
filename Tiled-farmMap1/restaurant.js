class restaurant extends Phaser.Scene {
    ...
    //step 1 load Json
        this.load.tilemapTiledJSON("restaurant","assets/restaurant.json");
         ...
         this.load.image("pizza", "assets/Farm Tiled MA1/pizza.png")
    }
    ...
    create() {
     ...
     let tileArray = [ pipoTiles, farmTiles, fenceTiles, fencealtTiles, plantsTiles, tallgrassTiles ]
       ...
       // collect item
       this.pizza = this.physics.add.sprite(270,308, 'pizza');
       //this.pizza2 = this.physics.add.sprite(530,430, 'pizza');

       // collect action
       this.physics.add.overlap( this.player,this.pizza,this.holditem, null, this );
